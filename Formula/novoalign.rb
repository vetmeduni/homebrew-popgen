class Novoalign < Formula
  ...
  version "3.07.01"
  url "http://www.novocraft.com/support/download/download.php?filename=V#{version}/novocraftV#{version}.#{OS.mac? ? "MacOSX" : "Linux2.6"}.tar.gz"
  sha256(
    if OS.mac? then "0ba6c5ef945bb04f8dc19c2a7da77ec3fa98bed36fdb15bd2c15c52da7eee4a6"
    # elsif OS.linux? then ""
